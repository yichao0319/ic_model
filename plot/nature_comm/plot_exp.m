...
function plot_coauthor(input_dir, fig_dir, font_size, legends, colors)
    ...
    set(h, 'Interpreter', 'latex', 'location', 'northeast', 'FontSize', 22);
...
function plot_dblp(input_dir, fig_dir, font_size, legends, colors)
    ...
    h = legend(lhs, legends);
    set(h, 'Interpreter', 'latex', 'location', 'southwest', 'FontSize', 22);
    leg_pos = get(h, 'position');
    set(h, 'position',[leg_pos(1)*0.95,leg_pos(2),...
                      leg_pos(3)*1.1,leg_pos(4)]);
...
function plot_dblp_network(input_dir, fig_dir, font_size, legends, colors)
    ...
    set(h, 'Interpreter', 'latex', 'location', 'southwest', 'FontSize', 22);
    leg_pos = get(h, 'position');
    set(h, 'position',[leg_pos(1)*1,leg_pos(2),...
                      leg_pos(3)*1.1,leg_pos(4)]);
...
function plot_patent(input_dir, fig_dir, font_size, legends, colors)
    ...
    h = legend(lhs, legends, 'location', 'southwest', 'FontSize', 22);
...
function plot_facebook(input_dir, fig_dir, font_size, legends, colors)
    ...
    h = legend(lhs, legends, 'FontSize', 22);
    set(h, 'Interpreter', 'latex');
    leg_pos = get(h, 'position');
    set(h, 'position',[leg_pos(1)*1,leg_pos(2),...
                      leg_pos(3)*1.1,leg_pos(4)]);
