...
data_dir = "./data/"
fig_dir  = "./figs/"
file_name = "sim.N100000.L3.U100000"
fig_name  = "sim-N100000-L3-U100000-fit"
...
plot data_dir.file_name.".emp.txt" using 1:2 with points ls 1 title '{/Helvetica=28 Empirical data}', \
    ...
    data_dir.file_name.".phase1-2.txt" using 1:2 with lines ls 3 notitle, \
    data_dir.file_name.".phase2-2.txt" using 1:2 with lines ls 4 title '{/Helvetica=28 Power-Law}', \
    data_dir.file_name.".phase2-1.txt" using 1:2 with lines ls 5 notitle
