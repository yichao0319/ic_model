...
function [a, exponent] = sim_ic_model_internal_link_poisson(N, itvl)
    % N = 100000;
    % N = 1000;
    ...
    %% save values
    %% --------------------
    dlmwrite(sprintf('%sL%dU%dN%d.internal_link.itvl%d.poisson.txt', output_dir, L, U, N, itvl), [x, y], 'delimiter', '\t');
end
