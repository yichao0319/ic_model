...
%%  plot_sim_internal_link_results(100000, 1, 1, 1, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 1, 10, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 1, 1000, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 100000, 1, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 100000, 10, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 100000, 1000, 'mc')
%%  plot_sim_internal_link_results(100000, 1, 100000, 1, 'rand')
%%  plot_sim_internal_link_results(100000, 1, 100000, 10, 'rand')
%%  plot_sim_internal_link_results(100000, 1, 100000, 1000, 'rand')
%%  plot_sim_internal_link_results(100000, 2, 8, 1, 'mc')
%%  plot_sim_internal_link_results(100000, 2, 8, 10, 'mc')
%%  plot_sim_internal_link_results(100000, 2, 8, 1000, 'mc')
%%  plot_sim_internal_link_results(100000, 2, 8, 1, 'rand')
%%  plot_sim_internal_link_results(100000, 2, 8, 10, 'rand')
%%  plot_sim_internal_link_results(100000, 2, 8, 1000, 'rand')
%%  plot_sim_internal_link_results(100000, 3, 10, 1, 'mc')
%%  plot_sim_internal_link_results(100000, 3, 10, 10, 'mc')
%%  plot_sim_internal_link_results(100000, 3, 10, 1000, 'mc')
%%  plot_sim_internal_link_results(100000, 3, 10, 1, 'rand')
%%  plot_sim_internal_link_results(100000, 3, 10, 10, 'rand')
%%  plot_sim_internal_link_results(100000, 3, 10, 1000, 'rand')

%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function plot_sim_internal_link_results(N, L, U, itvl, sel_type)
    % addpath('../utils');
