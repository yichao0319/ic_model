...
function parse_shanghai_bus_step2()
    % addpath('../utils');
    ...
    %% Constant
    %% --------------------
    input_dir  = './processed_shanghai_bus/';
    output_dir = './processed_shanghai_bus/';
    fig_dir = './fig_shanghai_bus/';
