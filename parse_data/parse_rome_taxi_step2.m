...
function parse_rome_taxi_step2()
    % addpath('../utils');
    ...
    %% Constant
    %% --------------------
    input_dir  = './processed_rome_taxi/';
    output_dir = './processed_rome_taxi/';
    fig_dir = './fig_rome_taxi/';
    ...
    % times = [min(times):10:min(times)+7*24*60*60]';
    times = [min(times):1:min(times)+24*60*60]';
